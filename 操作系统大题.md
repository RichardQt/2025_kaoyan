...
【「操作系统」动态分区分配算法】https://www.bilibili.com/video/BV1Ap4y167A9?vd_source=c8b64e308ba0a6999b868fdf4177d69f
...
- **物理地址 = 块号 `*` 页面大小+块内偏移地址**   （页面大小也可根据 **页内偏移量位** 数来计算，**若页内偏移量为 5 位，则页面大小为 2^5 = 32B**）  
